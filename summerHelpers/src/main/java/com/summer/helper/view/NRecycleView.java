...
public class NRecycleView extends RecyclerView {
    ...
    public void setDivider() {
        this.addItemDecoration(new DividerItemDecoration(getContext(), LinearLayoutManager.VERTICAL, getContext().getResources().getDrawable(R.drawable.so_greye1)));
    }
    ...
    public void setDividerColor(int colors, Rect rect) {
        addItemDecoration(new DividerItemDecoration(getContext(), LinearLayoutManager.VERTICAL, colors, rect));
    }
