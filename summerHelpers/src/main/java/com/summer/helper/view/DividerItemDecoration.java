...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int orientation, int drawable, Rect rectPadding) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        this.mPaintColor = drawable;
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        final int left = rectPadding.left;
        final int right = parent.getWidth() - rectPadding.right;
